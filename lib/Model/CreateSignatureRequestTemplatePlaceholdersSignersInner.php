...
/**
 * CreateSignatureRequestTemplatePlaceholdersSignersInner Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSignatureRequestTemplatePlaceholdersSignersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSignatureRequest_template_placeholders_signers_inner';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling CreateSignatureRequestTemplatePlaceholdersSignersInner., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling CreateSignatureRequestTemplatePlaceholdersSignersInner., must be bigger than or equal to 1.');
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($user_id)))) {
            throw new \InvalidArgumentException("invalid value for \$user_id when calling CreateSignatureRequestTemplatePlaceholdersSignersInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setContactId($contact_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($contact_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling CreateSignatureRequestTemplatePlaceholdersSignersInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
