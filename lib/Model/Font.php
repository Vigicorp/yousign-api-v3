    ...
    */
    ...
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#([a-f0-9]{6}|[A-F0-9]{6})$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling Font., must conform to the pattern /^#([a-f0-9]{6}|[A-F0-9]{6})$/.");
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 22)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Font., must be smaller than or equal to 22.');
        }
        if (($size < 8)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Font., must be bigger than or equal to 8.');
        }
