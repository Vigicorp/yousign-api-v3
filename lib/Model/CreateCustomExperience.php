...
/**
 * CreateCustomExperience Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCustomExperience implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCustomExperience';
    ...
    protected static $openAPITypes = [
        ...
        'redirect_urls' => '\Yousign\Client\Model\CreateCustomExperienceRedirectUrls'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('landing_page_disabled', $data ?? [], false);
        $this->setIfExists('side_panel_disabled', $data ?? [], false);
        ...
        $this->setIfExists('email_logo_disabled', $data ?? [], false);
        $this->setIfExists('email_header_text_disabled', $data ?? [], false);
        $this->setIfExists('email_footer_signature_disabled', $data ?? [], false);
        $this->setIfExists('email_expiration_text_disabled', $data ?? [], false);
    ...
    */
     ...
     * Sets name
     *
     * @param string $name This property cannot start or end with whitespace, does not allow HTML tags, URL or email.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateCustomExperience., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateCustomExperience., must be bigger than or equal to 1.');
        }
    ...
    public function setBackgroundColor($background_color)
    {
        ...
        if (!is_null($background_color) && (!preg_match("/^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/", ObjectSerializer::toString($background_color)))) {
            throw new \InvalidArgumentException("invalid value for \$background_color when calling CreateCustomExperience., must conform to the pattern /^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/.");
        }
    ...
    public function setButtonColor($button_color)
    {
        ...
        if (!is_null($button_color) && (!preg_match("/^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/", ObjectSerializer::toString($button_color)))) {
            throw new \InvalidArgumentException("invalid value for \$button_color when calling CreateCustomExperience., must conform to the pattern /^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/.");
        }
    ...
    public function setTextColor($text_color)
    {
        ...
        if (!is_null($text_color) && (!preg_match("/^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/", ObjectSerializer::toString($text_color)))) {
            throw new \InvalidArgumentException("invalid value for \$text_color when calling CreateCustomExperience., must conform to the pattern /^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/.");
        }
    ...
    public function setTextButtonColor($text_button_color)
    {
        ...
        if (!is_null($text_button_color) && (!preg_match("/^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/", ObjectSerializer::toString($text_button_color)))) {
            throw new \InvalidArgumentException("invalid value for \$text_button_color when calling CreateCustomExperience., must conform to the pattern /^(#[a-f0-9]{3}$)|(#[a-f0-9]{6}$)/.");
        }
     ...
     *
     * @return \Yousign\Client\Model\CustomExperienceDisabledNotificationsType[]|null
     */
     ...
     *
     * @param \Yousign\Client\Model\CustomExperienceDisabledNotificationsType[]|null $disabled_notifications disabled_notifications
     *
     * @return self
     */
     ...
     * Gets redirect_urls
     *
     * @return \Yousign\Client\Model\CreateCustomExperienceRedirectUrls|null
     */
     ...
     * Sets redirect_urls
     *
     * @param \Yousign\Client\Model\CreateCustomExperienceRedirectUrls|null $redirect_urls redirect_urls
     *
     * @return self
     */
