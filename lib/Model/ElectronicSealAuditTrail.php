 ...
 */
class ElectronicSealAuditTrail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ElectronicSealAuditTrail';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('seal', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($seal)) {
            throw new \InvalidArgumentException('non-nullable seal cannot be null');
        }
