 ...
 */
class UpdateContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateContact';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['first_name']) && !preg_match("/^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/", $this->container['first_name'])) {
            $invalidProperties[] = "invalid value for 'first_name', must be conform to the pattern /^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/.";
        }
        ...
        if (!is_null($this->container['last_name']) && !preg_match("/^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/", $this->container['last_name'])) {
            $invalidProperties[] = "invalid value for 'last_name', must be conform to the pattern /^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/.";
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UpdateContact., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/", ObjectSerializer::toString($first_name)))) {
            throw new \InvalidArgumentException("invalid value for \$first_name when calling UpdateContact., must conform to the pattern /^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/.");
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UpdateContact., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/", ObjectSerializer::toString($last_name)))) {
            throw new \InvalidArgumentException("invalid value for \$last_name when calling UpdateContact., must conform to the pattern /^(?!\\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\\'()\\- ]+(?<!\\s)$/.");
        }
     ...
     * Gets locale
     *
     * @return \Yousign\Client\Model\Locale|null
     */
     ...
     * Sets locale
     *
     * @param \Yousign\Client\Model\Locale|null $locale locale
     *
     * @return self
     */
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if (!is_null($job_title) && (mb_strlen($job_title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($job_title) && (mb_strlen($job_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine1($address_line_1)
    {
        ...
        if (!is_null($address_line_1) && (mb_strlen($address_line_1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line_1 when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($address_line_1) && (mb_strlen($address_line_1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line_1 when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($address_line_2)
    {
        ...
        if (!is_null($address_line_2) && (mb_strlen($address_line_2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line_2 when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($address_line_2) && (mb_strlen($address_line_2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line_2 when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressCity($address_city)
    {
        ...
        if (!is_null($address_city) && (mb_strlen($address_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($address_city) && (mb_strlen($address_city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressPostalCode($address_postal_code)
    {
        ...
        if (!is_null($address_postal_code) && (mb_strlen($address_postal_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_postal_code when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($address_postal_code) && (mb_strlen($address_postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_postal_code when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressCountry($address_country)
    {
        ...
        if (!is_null($address_country) && (mb_strlen($address_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling UpdateContact., must be smaller than or equal to 255.');
        }
        if (!is_null($address_country) && (mb_strlen($address_country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling UpdateContact., must be bigger than or equal to 1.');
        }
    ...
    public function setWorkspaceId($workspace_id)
    {
        ...
        if (!is_null($workspace_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workspace_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling UpdateContact., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
