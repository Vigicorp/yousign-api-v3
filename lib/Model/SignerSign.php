 ...
 */
class SignerSign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignerSign';
    ...
    */
    ...
    public function setOtp($otp)
    {
        ...
        if (!is_null($otp) && (!preg_match("/^[0-9]{6}$/", ObjectSerializer::toString($otp)))) {
            throw new \InvalidArgumentException("invalid value for \$otp when calling SignerSign., must conform to the pattern /^[0-9]{6}$/.");
        }
