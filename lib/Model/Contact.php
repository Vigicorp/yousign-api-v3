    ...
    */
    ...
    public function setWorkspaceId($workspace_id)
    {
        ...
        if (!is_null($workspace_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workspace_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling Contact., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
