...
class CreateSignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['template_id']) && !preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", $this->container['template_id'])) {
            $invalidProperties[] = "invalid value for 'template_id', must be conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.";
        }
     ...
     *
     * @return \Yousign\Client\Model\CreateSignatureRequestReminderSettings|null
     */
     ...
     *
     * @param \Yousign\Client\Model\CreateSignatureRequestReminderSettings|null $reminder_settings reminder_settings
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_date Due date of the signature request (yyyy-mm-dd). Default to 6 month after the activation.
     *
     * @return self
     */
    ...
    public function setTemplateId($template_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($template_id)))) {
            throw new \InvalidArgumentException("invalid value for \$template_id when calling CreateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setBrandingId($branding_id)
    {
        ...
        if (!is_null($branding_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($branding_id)))) {
            throw new \InvalidArgumentException("invalid value for \$branding_id when calling CreateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setCustomExperienceId($custom_experience_id)
    {
        ...
        if (!is_null($custom_experience_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($custom_experience_id)))) {
            throw new \InvalidArgumentException("invalid value for \$custom_experience_id when calling CreateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     * Gets signers
     *
     * @return \Yousign\Client\Model\CreateSignatureRequestSignersInner[]|null
     * @deprecated
     */
     ...
     * Sets signers
     *
     * @param \Yousign\Client\Model\CreateSignatureRequestSignersInner[]|null $signers Can only be used if you add documents at the same time.
     *
     * @return self
     * @deprecated
     */
    ...
    public function setWorkspaceId($workspace_id)
    {
        ...
        if (!is_null($workspace_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workspace_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling CreateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     *
     * @return \Yousign\Client\Model\CreateSignatureRequestTemplatePlaceholders|null
     */
     ...
     *
     * @param \Yousign\Client\Model\CreateSignatureRequestTemplatePlaceholders|null $template_placeholders template_placeholders
     *
     * @return self
     */
     ...
     * Gets archiving
     *
     * @return \Yousign\Client\Model\Archiving|null
     * @deprecated
     */
     ...
     * Sets archiving
     *
     * @param \Yousign\Client\Model\Archiving|null $archiving archiving
     *
     * @return self
     * @deprecated
     */
