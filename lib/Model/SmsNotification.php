 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmsNotification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SmsNotification';
    ...
    {
        $this->container['otp_message'] = isset($data['otp_message']) ? $data['otp_message'] : null;
    }
