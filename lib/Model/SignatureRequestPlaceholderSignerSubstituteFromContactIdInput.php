    ...
    */
    ...
    public function setContactId($contact_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($contact_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling SignatureRequestPlaceholderSignerSubstituteFromContactIdInput., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
