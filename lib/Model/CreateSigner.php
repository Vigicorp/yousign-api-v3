...
/**
 * CreateSigner Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSigner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSigner';
    ...
    protected static $openAPITypes = [
        'info' => '\Yousign\Client\Model\FromScratch1Info',
    ...
    */
     ...
     * Gets info
     *
     * @return \Yousign\Client\Model\FromScratch1Info
     */
     ...
     * Sets info
     *
     * @param \Yousign\Client\Model\FromScratch1Info $info info
     *
     * @return self
     */
    ...
    public function setInsertAfterId($insert_after_id)
    {
        ...
        if (!is_null($insert_after_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($insert_after_id)))) {
            throw new \InvalidArgumentException("invalid value for \$insert_after_id when calling CreateSigner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setIdentificationAttestationId($identification_attestation_id)
    {
        ...
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling CreateSigner., must be smaller than or equal to 255.');
        }
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling CreateSigner., must be bigger than or equal to 1.');
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($user_id)))) {
            throw new \InvalidArgumentException("invalid value for \$user_id when calling CreateSigner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setContactId($contact_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($contact_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling CreateSigner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
