 ...
 */
class Mention implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mention';
    ...
    */
    ...
    public function setSignerId($signer_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($signer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$signer_id when calling Mention., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling Mention., must be bigger than or equal to 1.');
        }
    ...
    public function setX($x)
    {
        ...
        if (($x > 32767)) {
            throw new \InvalidArgumentException('invalid value for $x when calling Mention., must be smaller than or equal to 32767.');
        }
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling Mention., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y > 32767)) {
            throw new \InvalidArgumentException('invalid value for $y when calling Mention., must be smaller than or equal to 32767.');
        }
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling Mention., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 24)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Mention., must be bigger than or equal to 24.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height < 24)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Mention., must be bigger than or equal to 24.');
        }
    ...
    public function setMention($mention)
    {
        ...
        if ((mb_strlen($mention) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mention when calling Mention., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($mention) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mention when calling Mention., must be bigger than or equal to 1.');
        }
