 ...
 */
class Checkbox1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Checkbox_1';
    ...
    */
    ...
    public function setSignerId($signer_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($signer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$signer_id when calling Checkbox1., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling Checkbox1., must be bigger than or equal to 1.');
        }
    ...
    public function setX($x)
    {
        ...
        if (($x > 32767)) {
            throw new \InvalidArgumentException('invalid value for $x when calling Checkbox1., must be smaller than or equal to 32767.');
        }
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling Checkbox1., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y > 32767)) {
            throw new \InvalidArgumentException('invalid value for $y when calling Checkbox1., must be smaller than or equal to 32767.');
        }
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling Checkbox1., must be bigger than or equal to 0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 30)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Checkbox1., must be smaller than or equal to 30.');
        }
        if (($size < 8)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Checkbox1., must be bigger than or equal to 8.');
        }
