...
/**
 * InitialsArea Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class InitialsArea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitialsArea';
    ...
    */
    ...
    public function setY($y)
    {
        ...
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling InitialsArea., must be bigger than or equal to 0.');
        }
