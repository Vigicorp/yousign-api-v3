...
/**
 * CreateSignatureRequestSignersInner Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateSignatureRequestSignersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSignatureRequest_signers_inner';
    ...
    */
     ...
     * Gets redirect_urls
     *
     * @return \Yousign\Client\Model\SignatureRequestSignerFromInfoInputRedirectUrls|null
     */
     ...
     * Sets redirect_urls
     *
     * @param \Yousign\Client\Model\SignatureRequestSignerFromInfoInputRedirectUrls|null $redirect_urls redirect_urls
     *
     * @return self
     */
    ...
    public function setUserId($user_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($user_id)))) {
            throw new \InvalidArgumentException("invalid value for \$user_id when calling CreateSignatureRequestSignersInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setContactId($contact_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($contact_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling CreateSignatureRequestSignersInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
