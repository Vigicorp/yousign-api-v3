...
/**
 * GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_signature_requests_signatureRequestId_documents_documentId_fields_200_response_data_inner';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setDocumentId($document_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($document_id)))) {
            throw new \InvalidArgumentException("invalid value for \$document_id when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setSignerId($signer_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($signer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$signer_id when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 24)) {
            throw new \InvalidArgumentException('invalid value for $height when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 24.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 24)) {
            throw new \InvalidArgumentException('invalid value for $width when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 24.');
        }
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setX($x)
    {
        ...
        if (($x > 32767)) {
            throw new \InvalidArgumentException('invalid value for $x when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 32767.');
        }
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y > 32767)) {
            throw new \InvalidArgumentException('invalid value for $y when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 32767.');
        }
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 0.');
        }
    ...
    public function setQuestion($question)
    {
        ...
        if ((mb_strlen($question) > 255)) {
            throw new \InvalidArgumentException('invalid length for $question when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 255.');
        }
    ...
    public function setMaxLength($max_length)
    {
        ...
        if (($max_length > 32767)) {
            throw new \InvalidArgumentException('invalid value for $max_length when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 32767.');
        }
        if (($max_length < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_length when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 128.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 30)) {
            throw new \InvalidArgumentException('invalid value for $size when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 30.');
        }
        if (($size < 8)) {
            throw new \InvalidArgumentException('invalid value for $size when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 8.');
        }
     ...
     * Gets radios
     *
     * @return \Yousign\Client\Model\FieldRadioButtonGroupRadiosInner[]
     */
     ...
     * Sets radios
     *
     * @param \Yousign\Client\Model\FieldRadioButtonGroupRadiosInner[] $radios radios
     *
     * @return self
     */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 5000.');
        }
