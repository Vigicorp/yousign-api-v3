 ...
 */
class SignatureRequestPlaceholderSignerSubstituteFromInfoInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureRequest_PlaceholderSignerSubstituteFromInfoInput';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling SignatureRequestPlaceholderSignerSubstituteFromInfoInput., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling SignatureRequestPlaceholderSignerSubstituteFromInfoInput., must be bigger than or equal to 1.');
        }
