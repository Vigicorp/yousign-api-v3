 ...
 */
class SignerAuditTrail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignerAuditTrail';
    ...
    protected static array $openAPINullables = [
        ...
        'electronic_signature_level' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('signature_request', $data ?? [], null);
        $this->setIfExists('sender', $data ?? [], null);
        $this->setIfExists('signer', $data ?? [], null);
        $this->setIfExists('documents', $data ?? [], null);
        $this->setIfExists('organization', $data ?? [], null);
        $this->setIfExists('authentication', $data ?? [], null);
        $this->setIfExists('electronic_signature_level', $data ?? [], null);
    }
    ...
    */
    ...
    public function setDocuments($documents)
    {
        ...
        if ((count($documents) < 1)) {
            throw new \InvalidArgumentException('invalid length for $documents when calling SignerAuditTrail., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param object|null $electronic_signature_level electronic_signature_level
     *
     * @return self
     */
    public function setElectronicSignatureLevel($electronic_signature_level)
    {
        if (is_null($electronic_signature_level)) {
            throw new \InvalidArgumentException('non-nullable electronic_signature_level cannot be null');
        }
