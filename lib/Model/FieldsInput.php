...
class FieldsInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'checked' => 'bool',
        'radios' => '\Yousign\Client\Model\RadioGroup2RadiosInner[]'
    ];
    ...
    */
    ...
    public function setDocumentId($document_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($document_id)))) {
            throw new \InvalidArgumentException("invalid value for \$document_id when calling FieldsInput., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 30)) {
            throw new \InvalidArgumentException('invalid value for $size when calling FieldsInput., must be smaller than or equal to 30.');
        }
        if (($size < 8)) {
     ...
     * Gets radios
     *
     * @return \Yousign\Client\Model\RadioGroup2RadiosInner[]
     */
     ...
     * Sets radios
     *
     * @param \Yousign\Client\Model\RadioGroup2RadiosInner[] $radios radios
     *
     * @return self
     */
