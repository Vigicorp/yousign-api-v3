...
/**
 * FromScratch1 Class Doc Comment
 *
 * @category Class
 ...
 */
class FromScratch1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'From_Scratch_1';
    ...
    */
    ...
    public function setInsertAfterId($insert_after_id)
    {
        ...
        if (!is_null($insert_after_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($insert_after_id)))) {
            throw new \InvalidArgumentException("invalid value for \$insert_after_id when calling FromScratch1., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setIdentificationAttestationId($identification_attestation_id)
    {
        ...
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling FromScratch1., must be smaller than or equal to 255.');
        }
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling FromScratch1., must be bigger than or equal to 1.');
        }
