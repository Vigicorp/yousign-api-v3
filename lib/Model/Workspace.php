...
class Workspace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'deleted_at' => '\DateTime',
        'users' => '\Yousign\Client\Model\WorkspaceUsersInner[]'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling Workspace., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     * Gets users
     *
     * @return \Yousign\Client\Model\WorkspaceUsersInner[]
     */
     ...
     * Sets users
     *
     * @param \Yousign\Client\Model\WorkspaceUsersInner[] $users users
     *
     * @return self
     */
