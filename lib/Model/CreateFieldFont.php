 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateFieldFont implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateFieldFont';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['color'] = isset($data['color']) ? $data['color'] : '#000000';
        $this->container['size'] = isset($data['size']) ? $data['size'] : 12;
