...
class CreateFieldFont implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 22)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CreateFieldFont., must be smaller than or equal to 22.');
        }
        if (($size < 8)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CreateFieldFont., must be bigger than or equal to 8.');
        }
