...
class SignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'decline_information' => '\Yousign\Client\Model\SignatureRequestDeclineInformation'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling SignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setBrandingId($branding_id)
    {
        ...
        if (!is_null($branding_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($branding_id)))) {
            throw new \InvalidArgumentException("invalid value for \$branding_id when calling SignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setCustomExperienceId($custom_experience_id)
    {
        ...
        if (!is_null($custom_experience_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($custom_experience_id)))) {
            throw new \InvalidArgumentException("invalid value for \$custom_experience_id when calling SignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setWorkspaceId($workspace_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workspace_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling SignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setBulkSendBatchId($bulk_send_batch_id)
    {
        ...
        if (!is_null($bulk_send_batch_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($bulk_send_batch_id)))) {
            throw new \InvalidArgumentException("invalid value for \$bulk_send_batch_id when calling SignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     *
     * @return \Yousign\Client\Model\SignatureRequestDeclineInformation|null
     */
     ...
     *
     * @param \Yousign\Client\Model\SignatureRequestDeclineInformation|null $decline_information decline_information
     *
     * @return self
     */
