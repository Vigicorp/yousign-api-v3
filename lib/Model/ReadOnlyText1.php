...
/**
 * ReadOnlyText1 Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReadOnlyText1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReadOnlyText_1';
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling ReadOnlyText1., must be bigger than or equal to 1.');
        }
    ...
    public function setX($x)
    {
        ...
        if (($x > 32767)) {
            throw new \InvalidArgumentException('invalid value for $x when calling ReadOnlyText1., must be smaller than or equal to 32767.');
        }
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling ReadOnlyText1., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y > 32767)) {
            throw new \InvalidArgumentException('invalid value for $y when calling ReadOnlyText1., must be smaller than or equal to 32767.');
        }
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling ReadOnlyText1., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width < 24)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ReadOnlyText1., must be bigger than or equal to 24.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height < 24)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ReadOnlyText1., must be bigger than or equal to 24.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ReadOnlyText1., must be smaller than or equal to 5000.');
        }
