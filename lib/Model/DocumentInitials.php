...
/**
 * DocumentInitials Class Doc Comment
 *
 * @category Class
 * @package  Yousign\Client
 * @author   OpenAPI Generator team
 ...
 */
class DocumentInitials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Document_initials';
    ...
    */
     ...
     * Sets alignment
     *
     * @param string $alignment Initials alignment on the document
     *
     * @return self
     */
     ...
     * Sets y
     *
     * @param int $y y-axis position on the document
     *
     * @return self
     */
    public function setY($y)
    {
        ...
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling DocumentInitials., must be bigger than or equal to 0.');
        }
