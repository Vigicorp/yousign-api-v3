 ...
 */
class EmbeddedSignerWithSignatureLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbeddedSignerWithSignatureLink';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling EmbeddedSignerWithSignatureLink., must be bigger than or equal to 1.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling EmbeddedSignerWithSignatureLink., must be bigger than or equal to 1.');
        }
    ...
    public function setSignatureLink($signature_link)
    {
        ...
        if (!is_null($signature_link) && (mb_strlen($signature_link) < 1)) {
            throw new \InvalidArgumentException('invalid length for $signature_link when calling EmbeddedSignerWithSignatureLink., must be bigger than or equal to 1.');
        }
