 ...
 */
class UpdateWebhookSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateWebhookSubscription';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'sandbox' => 'bool',
        'subscribed_events' => '\Yousign\Client\Model\CreateWebhookSubscriptionSubscribedEvents',
        'secret_key' => 'string',
        'scopes' => '\Yousign\Client\Model\CreateWebhookSubscriptionScopes',
        'workspaces' => '\Yousign\Client\Model\CreateWebhookSubscriptionWorkspaces',
        'auto_retry' => 'bool',
        'enabled' => 'bool'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['endpoint']) && (mb_strlen($this->container['endpoint']) > 255)) {
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint Https target URL of the webhook
     *
     * @return self
     */
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 255)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling UpdateWebhookSubscription., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Short description of the webhook. This property cannot start or end with whitespace, does not allow HTML tags, URL or email.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateWebhookSubscription., must be smaller than or equal to 128.');
        }
     ...
     *
     * @return \Yousign\Client\Model\CreateWebhookSubscriptionSubscribedEvents|null
     */
     ...
     *
     * @param \Yousign\Client\Model\CreateWebhookSubscriptionSubscribedEvents|null $subscribed_events subscribed_events
     *
     * @return self
     */
    ...
    public function setSecretKey($secret_key)
    {
        ...
        if (!is_null($secret_key) && (mb_strlen($secret_key) > 32)) {
            throw new \InvalidArgumentException('invalid length for $secret_key when calling UpdateWebhookSubscription., must be smaller than or equal to 32.');
        }
        if (!is_null($secret_key) && (mb_strlen($secret_key) < 32)) {
            throw new \InvalidArgumentException('invalid length for $secret_key when calling UpdateWebhookSubscription., must be bigger than or equal to 32.');
        }
     ...
     * Gets scopes
     *
     * @return \Yousign\Client\Model\CreateWebhookSubscriptionScopes|null
     */
     ...
     * Sets scopes
     *
     * @param \Yousign\Client\Model\CreateWebhookSubscriptionScopes|null $scopes scopes
     *
     * @return self
     */
     ...
     * Gets workspaces
     *
     * @return \Yousign\Client\Model\CreateWebhookSubscriptionWorkspaces|null
     */
     ...
     * Sets workspaces
     *
     * @param \Yousign\Client\Model\CreateWebhookSubscriptionWorkspaces|null $workspaces workspaces
     *
     * @return self
     */
     ...
     * Sets auto_retry
     *
     * @param bool|null $auto_retry If a Webhook request fails for any reason, Yousign will retry the request 8 times using a back-off mechanism after: 2, 6, 30, 60, 300, 1080, 1440, 2880 min
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Choose whether the webhook is enabled or not.
     *
     * @return self
     */
