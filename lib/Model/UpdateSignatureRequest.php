 ...
 */
class UpdateSignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSignatureRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['branding_id']) && !preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", $this->container['branding_id'])) {
        ...
        if (!is_null($this->container['custom_experience_id']) && !preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", $this->container['custom_experience_id'])) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateSignatureRequest., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateSignatureRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets delivery_mode
     *
     * @param string|null $delivery_mode Delivery mode to notify signers.
     *
     * @return self
     */
     ...
     *
     * @return \Yousign\Client\Model\UpdateSignatureRequestReminderSettings|null
     */
     ...
     *
     * @param \Yousign\Client\Model\UpdateSignatureRequestReminderSettings|null $reminder_settings reminder_settings
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone tz database format
     *
     * @return self
     */
     ...
     *
     * @param string|null $email_custom_note email_custom_note
     *
     * @return self
     * @deprecated
     */
    public function setEmailCustomNote($email_custom_note)
    {
        ...
        if (!is_null($email_custom_note) && (mb_strlen($email_custom_note) > 500)) {
            throw new \InvalidArgumentException('invalid length for $email_custom_note when calling UpdateSignatureRequest., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param \DateTime|null $expiration_date Due date of the signature request (yyyy-mm-dd).
     *
     * @return self
     */
    public function setExpirationDate($expiration_date)
    {
        ...
        if ((!preg_match("/^\\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$/", ObjectSerializer::toString($expiration_date)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date when calling UpdateSignatureRequest., must conform to the pattern /^\\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$/.");
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if (!is_null($external_id) && (mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling UpdateSignatureRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($external_id) && (!preg_match("/^[\\w\\-@.%+]+$/", ObjectSerializer::toString($external_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_id when calling UpdateSignatureRequest., must conform to the pattern /^[\\w\\-@.%+]+$/.");
        }
    ...
    public function setBrandingId($branding_id)
    {
        ...
        if (!is_null($branding_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($branding_id)))) {
            throw new \InvalidArgumentException("invalid value for \$branding_id when calling UpdateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setCustomExperienceId($custom_experience_id)
    {
        ...
        if (!is_null($custom_experience_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($custom_experience_id)))) {
            throw new \InvalidArgumentException("invalid value for \$custom_experience_id when calling UpdateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     * Sets workspace_id
     *
     * @param string|null $workspace_id Transfer the Signature Request into a given Workspace.
     *
     * @return self
     */
    public function setWorkspaceId($workspace_id)
    {
        ...
        if (!is_null($workspace_id) && (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($workspace_id)))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling UpdateSignatureRequest., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     *
     * @return \Yousign\Client\Model\AuditTrailLocale|null
     */
     ...
     *
     * @param \Yousign\Client\Model\AuditTrailLocale|null $audit_trail_locale Define the locale for the generated audit trail.
     *
     * @return self
     */
     ...
     *
     * @return \Yousign\Client\Model\SignatureRequestEmailNotification|null
     */
     ...
     *
     * @param \Yousign\Client\Model\SignatureRequestEmailNotification|null $email_notification email_notification
     *
     * @return self
     */
