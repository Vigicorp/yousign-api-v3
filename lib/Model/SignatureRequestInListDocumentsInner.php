 ...
 */
class SignatureRequestInListDocumentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureRequestInList_documents_inner';
