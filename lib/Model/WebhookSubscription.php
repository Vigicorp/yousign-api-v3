    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling WebhookSubscription., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 255)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling WebhookSubscription., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WebhookSubscription., must be smaller than or equal to 128.');
        }
     ...
     * Gets workspaces
     *
     * @return \Yousign\Client\Model\WebhookSubscriptionWorkspaces
     */
     ...
     * Sets workspaces
     *
     * @param \Yousign\Client\Model\WebhookSubscriptionWorkspaces $workspaces workspaces
     *
     * @return self
     */
