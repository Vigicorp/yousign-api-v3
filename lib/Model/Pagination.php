...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['next_cursor']) < 1)) {
    ...
    public function setNextCursor($next_cursor)
    {
        ...
        if (!is_null($next_cursor) && (mb_strlen($next_cursor) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_cursor when calling Pagination., must be bigger than or equal to 1.');
        }
