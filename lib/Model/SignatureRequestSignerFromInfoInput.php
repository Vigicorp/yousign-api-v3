 ...
 */
class SignatureRequestSignerFromInfoInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureRequest_SignerFromInfoInput';
